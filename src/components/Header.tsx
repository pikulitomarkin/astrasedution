    ...
    <header className="fixed top-0 z-50 w-full">
      <div className="mx-auto max-w-7xl px-6 py-4 lg:px-8">
        ...
        >
          ...
          {/* Visitante: contador + nav marketing + login */}
          {!isAuthenticated && (
            <>
              <motion.div
          ...
          {/* Logado: somente manequim de perfil */}
          {isAuthenticated && (
            <div className="relative" ref={userMenuRef}>
              <button
                type="button"
                onClick={() => setIsUserMenuOpen((open) => !open)}
                className="group relative flex h-11 w-11 items-center justify-center rounded-full border border-gold-primary/40 bg-gradient-to-br from-zinc-900 to-black shadow-[0_0_20px_rgba(201,162,39,0.15)] transition-all hover:border-gold-primary hover:shadow-[0_0_24px_rgba(201,162,39,0.28)]"
